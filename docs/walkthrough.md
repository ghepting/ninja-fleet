...
- **SSL**: Caddy is correctly managing wildcard certificates for `ghepting.com`.
...
### Ninja-Server: 100% Success

```bash
PLAY RECAP ***************************************************************
ninja-server      : ok=36   changed=0    unreachable=0    failed=0
```

### Ninja-MBP: 100% Success

```bash
PLAY RECAP ***************************************************************
ninja-mbp         : ok=37   changed=0    unreachable=0    failed=0
```
